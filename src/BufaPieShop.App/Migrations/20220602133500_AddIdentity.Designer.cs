...
namespace BufaPieShop.App.Migrations
{
    ...
    [Migration("20220602133500_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.OrderDetail", b =>
                {
                    b.HasOne("BufaPieShop.App.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BufaPieShop.App.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BufaPieShop.App.Models.Pie", b =>
                {
                    b.HasOne("BufaPieShop.App.Models.Category", "Category")
                        .WithMany("Pies")
